...
-- initialize dqn
local bdqn_param = {headNum = headNum, replaySize = 10000, batchSize = 16, discount = 0.9, epsilon = 0.1}
...
-- initialize dql
local dql_param = {step = 20, lr = 0.1, updatePeriod = 8}
...
local report = function(bdql)
  print(bdql.dqn.Qvalue)
end


bdql:learning(5000,report)
